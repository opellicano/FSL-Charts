$(document).ready(function () {
  ...
  var averageRating = new Chart(ctx, {
    type: "bar",
    data: {
      labels: ["2021 - Q1", "2021 - Q2", "2021 - Q3", "2022 - Q1", "2022 - Q3", "2023 - Q1"],
      datasets: [
        {
          label: "Average",
          data: [4.38, 4.44, 4.41, 4.41, 4.39, 4.41],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ],
    },
      ...
      datasets: [
        {
          ...
          data: [4.62, 4.71, 4.67, 4.66, 4.70, 4.72],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.69, 4.65, 4.63, 4.70, 4.71, 4.72],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)" ],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.60, 4.48, 4.51, 4.44, 4.47, 4.49],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.23, 4.34, 4.28, 4.33, 4.30, 4.40],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.46, 4.55, 4.62, 4.47, 4.44, 4.64],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.57, 4.64, 4.59, 4.59, 4.51, 4.53],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
      ...
      datasets: [
        {
          ...
          data: [4.12, 4.20, 4.15, 4.28, 4.16, 4.07],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
 ...
 var ctxQuality = document.getElementById("npsQuality");
  var npsQuality = new Chart(ctxQuality, {
    type: "bar",
    data: {
      labels: ["2021 - Q2", "2021 - Q3", "2021 - Q4", "2022 - 1H", "2023 - Q1"],
      datasets: [
        {
          label:
            "Average score of the quality of our work",
          data: [8.9, 8.8, 9.3, 9.0, 9.0],
      ...
      datasets: [
        {
          ...
          data: [4.27, 4.46, 4.36, 4.47, 4.42, 4.41],
          backgroundColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderColor: ["rgba(24, 204, 85,100)", "rgba(55, 68, 95, 100)", "rgba(242, 153, 74, 100)", "rgba(155, 81, 224, 100)", "rgba(235, 87, 87, 100)", "rgba(44, 106, 250, 100)"],
          borderWidth: 1,
        },
