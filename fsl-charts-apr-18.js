$(document).ready(function () {
  ...
  var averageRating = new Chart(ctx, {
    type: "bar",
    data: {
      labels: ["2020 - Q2", "2021 - Q1", "2021 - Q2", "2021 - Q3"],
      datasets: [
        {
          label: "Average",
          data: [4.2, 4.3, 4.6, 4.1],
